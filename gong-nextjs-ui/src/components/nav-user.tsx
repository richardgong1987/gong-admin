                    ...
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <Avatar className="h-8 w-8 rounded-lg">
                                <AvatarImage src={storeUser.headerImg || user.avatar}
                                             alt={storeUser.userName}/>
                                <AvatarFallback className="rounded-lg">CN</AvatarFallback>
                            </Avatar>
                            <div className="grid flex-1 text-left text-sm leading-tight">
                                <span className="truncate font-medium">{storeUser.userName}</span>
                                <span className="truncate text-xs">{storeUser.email}</span>
                            </div>
                    ...
                    >
                        <DropdownMenuLabel className="p-0 font-normal">
                            <div className="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
                                <Avatar className="h-8 w-8 rounded-lg">
                                    <AvatarImage src={user.avatar} alt={storeUser.userName}/>
                                    <AvatarFallback className="rounded-lg">CN</AvatarFallback>
                                </Avatar>
                                <div className="grid flex-1 text-left text-sm leading-tight">
                                    <span className="truncate font-medium">{storeUser.userName}</span>
